          ...
          <div className='py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end'>
            <div>
              <div className='mb-4'>
                ...
                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>EcoScan</p>
          ...
          <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/70 text-white rounded-3xl relative h-[320px] flex items-end'>
            <div>
              <div className='mb-4'>
                ...
                <Button text="Buscar" bgColor="bg-white" textColor="text-brandYellow" />
              </div>
            </div>
            {/* <img src="" alt="" className='w-[320px] absolute bottom-0' /> */}
          </div>
          ...
          <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end'>
            <div>
              <div className='space-y-3 mb-4'>
                ...
                <Button text="Buscar" bgColor="bg-white" textColor="text-primary" />
              </div>
            </div>
