  ...
  return (
    <div className="mb-10">
      <Link to={`/contenedores/${data.id}`} key={data.id}>
        <div className="group w-full max-w-xs mx-auto rounded-lg border border-gray-200 shadow-lg hover:shadow-2xl transition duration-300 bg-white dark:bg-gray-800">
