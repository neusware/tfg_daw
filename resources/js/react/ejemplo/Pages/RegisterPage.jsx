...
function RegisterPage() {
    ...
    const handleChange = (e) => {
        ...
        setFormData({
            ...formData,
            [name]:
                name === "saldo" || name === "id_suscripcion" ? parseFloat(value): value,
        });
    };
        ...
        <div className="bg-primary dark:bg-gray-900 min-h-screen flex items-center justify-center px-4 py-40">
            <div className="max-w-5xl w-full lg:flex bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border dark:border-gray-700">
                ...
                <div className="lg:w-1/2 p-10 bg-gray-100 dark:bg-gray-900 flex flex-col justify-center">
                    <h1 className="text-red font-extrabold tracking-widest text-3xl sm:text-6xl mb-4">
                        EcoScan
                    </h1>
                    <p className="text-gray-700 dark:text-gray-300 text-lg">
                        ¡Bienvenido a la comunidad! Crea tu cuenta para comenzar
                        a usar nuestra plataforma y aprovechar todo su
                        potencial.
                    </p>
                    <p className="mt-4 text-sm text-gray-600 dark:text-gray-400">
                        Con una cuenta podrás escanear productos, analizar su
                        impacto y contribuir a un consumo más sostenible.
                    </p>
                </div>
                            ...
                            <span className="absolute left-3 text-gray-400 dark:text-gray-500">
                                ...
                                >
                                    <path
                                        ...
                                        strokeWidth="2"
                                        d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.735 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0z"
                                    />
                                </svg>
                            </span>
                            <input
