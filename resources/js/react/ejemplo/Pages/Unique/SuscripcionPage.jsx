...
function SuscripcionPage({ data }) {
    ...
    if (loading)
        return <div className="text-center mt-10">Cargando contendor...</div>;
    if (!contenedor)
        return (
        ...
        <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8 space-y-10">
            <div className="text-center">
                ...
                <p className="mt-4 text-xl text-gray-700 dark:text-gray-300">
                    Color:{" "}
                    <span className="font-semibold">{contenedor.color}</span>
                </p>
            </div>
